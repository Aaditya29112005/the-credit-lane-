...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='20' fill='%23FFFFFF'/><path d='M 72 26 C 63 17 48 15 36 21 C 21 28 14 44 16 60 C 19 76 33 87 49 87 C 62 87 74 79 79 66 L 66 61 C 62 70 53 74 44 74 C 33 74 24 66 22 55 C 20 42 27 31 38 27 C 47 23 57 25 64 32 Z' fill='%230B1F3A'/><path d='M 43 28 C 39 36 38 46 38 56 L 38 74 L 68 74 L 68 62 L 50 62 L 50 42 C 50 36 47 31 43 28 Z' fill='%230B1F3A'/></svg>">
  ...
  <header>
    <div class="wrap">
      <a href="{pref}index.html" class="logo">
        <svg viewBox="0 0 100 100" class="logo-svg" style="width: 40px; height: 40px; flex-shrink: 0; display: block;">
          <rect width="100" height="100" rx="20" fill="#FFFFFF" stroke="rgba(11, 31, 58, 0.12)" stroke-width="2"/>
          <path d="M 72 26 C 63 17 48 15 36 21 C 21 28 14 44 16 60 C 19 76 33 87 49 87 C 62 87 74 79 79 66 L 66 61 C 62 70 53 74 44 74 C 33 74 24 66 22 55 C 20 42 27 31 38 27 C 47 23 57 25 64 32 Z" fill="#0B1F3A"/>
          <path d="M 43 28 C 39 36 38 46 38 56 L 38 74 L 68 74 L 68 62 L 50 62 L 50 42 C 50 36 47 31 43 28 Z" fill="#0B1F3A"/>
        </svg>
        THE CREDIT LANE
      </a>
      <nav class="mainnav">
