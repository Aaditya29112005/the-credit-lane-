    ...
    <section class="about-hero-section" style="padding: 80px 0 60px !important; background: linear-gradient(135deg, #0B1F3A 0%, #071529 100%) !important; color: #FFFFFF !important; position: relative !important; overflow: hidden !important;">
      <div class="wrap" style="display: grid !important; grid-template-columns: 1.05fr 0.95fr !important; gap: 48px !important; align-items: center !important; width: 100% !important;">
        ...
        <div style="position: relative; width: 100%;">
          <div style="background: rgba(255, 255, 255, 0.04); border: 1.5px solid rgba(200, 155, 60, 0.4); border-radius: 20px; padding: 10px; box-shadow: 0 20px 50px rgba(0,0,0,0.5); backdrop-filter: blur(10px); cursor: pointer;" onclick="openGalleryModal('../about/image copy 8.png')">
            <img src="../about/image copy 8.png" alt="The Credit Lane Executive Exhibition &amp; Office Stall" style="width: 100%; height: 440px; object-fit: cover; border-radius: 14px; display: block; box-shadow: 0 8px 25px rgba(0,0,0,0.3);">
          </div>
        </div>
      </div>
    </section>
