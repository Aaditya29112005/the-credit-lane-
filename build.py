      ...
      <div class="wrap">
        ...
        <div class="service-banner-art" style="display: flex; align-items: center; justify-content: center; width: 100%;">
          <div style="width: 100%; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.15); border-radius: 20px; padding: 10px; box-shadow: 0 15px 40px rgba(0,0,0,0.35);">
            <img src="../about/WhatsApp Image 2026-08-11 at 10.10.23.jpeg" alt="The Credit Lane Founders & Leadership Team" style="width: 100%; height: auto; max-height: 440px; object-fit: contain; border-radius: 14px; display: block;">
        ...
        <div class="about-story" style="display: grid; grid-template-columns: 1.1fr 0.9fr; gap: 48px; align-items: center;">
          <div>
            ...
            <div style="display: flex; gap: 16px; flex-wrap: wrap; align-items: center;">
              <a href="../contact/index.html" class="btn btn-primary" style="padding: 14px 28px; font-size: 15px; font-weight: 700; box-shadow: 0 6px 20px rgba(184,134,11,0.25);">Talk to Our Founders &rarr;</a>
          ...
          <div class="about-graphics" style="padding: 0; overflow: hidden; display: flex; flex-direction: column; border-radius: 20px; border: 1px solid var(--line); background: var(--white); box-shadow: 0 10px 30px rgba(0,0,0,0.06);">
            <div style="width: 100%; height: 260px; overflow: hidden; position: relative;">
              <img src="../about/image copy 16.png" alt="Build Bharat Expo Showcase" style="width: 100%; height: 100%; object-fit: cover; object-position: center; display: block;">
            </div>
            <div style="padding: 28px 24px; text-align: center;">
              <div class="about-logo-wrapper" style="margin: 0 auto 14px; display: inline-block;">
                <img src="../about/image.png" alt="The Credit Lane Logo" style="width: 60px; height: 60px; object-fit: contain; border-radius: 12px; padding: 6px; background: #fff; box-shadow: 0 4px 14px rgba(0,0,0,0.1); border: 1px solid var(--line);">
              </div>
        ...
        <div class="founders-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 32px;">
          ...
          <div class="founder-card" style="background: var(--offwhite); border: 1px solid var(--line); border-radius: 18px; overflow: hidden; box-shadow: 0 6px 24px rgba(0,0,0,0.05); transition: transform 0.3s ease;">
            <div style="height: 340px; overflow: hidden; position: relative;">
              <img src="../about/image copy 15.png" alt="Rajat Garg - Founder & Managing Director" style="width: 100%; height: 100%; object-fit: cover; object-position: top center; display: block;">
            </div>
          ...
          <div class="founder-card" style="background: var(--offwhite); border: 1px solid var(--line); border-radius: 18px; overflow: hidden; box-shadow: 0 6px 24px rgba(0,0,0,0.05); transition: transform 0.3s ease;">
            <div style="height: 340px; overflow: hidden; position: relative;">
              <img src="../about/image copy 2.png" alt="Co-Founder - Financial Advisory & Credit Underwriting" style="width: 100%; height: 100%; object-fit: cover; object-position: top center; display: block;">
            </div>
            <div style="padding: 24px;">
          ...
          <div class="founder-card" style="background: var(--offwhite); border: 1px solid var(--line); border-radius: 18px; overflow: hidden; box-shadow: 0 6px 24px rgba(0,0,0,0.05); transition: transform 0.3s ease;">
            <div style="height: 340px; overflow: hidden; position: relative;">
              <img src="../about/image copy 3.png" alt="Co-Founder - Legal & Compliance Chambers" style="width: 100%; height: 100%; object-fit: cover; object-position: top center; display: block;">
            </div>
            <div style="padding: 24px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 32px; align-items: stretch; margin-bottom: 48px;">
          ...
          <div style="background: #fff; padding: 24px; border-radius: 18px; border: 1px solid var(--line); box-shadow: 0 8px 30px rgba(0,0,0,0.06); text-align: center; display: flex; flex-direction: column; justify-content: space-between;">
            <div>
              ...
              <div style="overflow: hidden; border-radius: 12px; border: 1px solid var(--line); margin-bottom: 12px; cursor: pointer;" onclick="openGalleryModal('../about/BRT CorporateBBE Participation Certificate_page-0001.jpg')">
                <img src="../about/BRT CorporateBBE Participation Certificate_page-0001.jpg" alt="Build Bharat Expo 2025 Participation Certificate" style="width: 100%; height: auto; display: block; transition: transform 0.3s ease;" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">
              </div>
            </div>
          ...
          <div style="background: #fff; padding: 24px; border-radius: 18px; border: 1px solid var(--line); box-shadow: 0 8px 30px rgba(0,0,0,0.06); text-align: center; display: flex; flex-direction: column; justify-content: space-between;">
            <div>
              ...
              <div style="overflow: hidden; border-radius: 12px; border: 1px solid var(--line); margin-bottom: 12px; cursor: pointer;" onclick="openGalleryModal('../about/WhatsApp Image 2026-08-11 at 10.10.23.jpeg')">
                <img src="../about/WhatsApp Image 2026-08-11 at 10.10.23.jpeg" alt="The Credit Lane Exhibition Booth" style="width: 100%; height: auto; max-height: 320px; object-fit: cover; display: block; transition: transform 0.3s ease;" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">
              </div>
            </div>
            ...
            <form class="lead-form" action="https://formsubmit.co/Info@thecreditlane.in" method="POST">
              ...
              <div class="form-grid">
                ...
                <div class="form-group">
                  ...
                  <input type="email" name="Email Address" placeholder="you@company.com" required>
                </div>
              </div>
              <div class="form-grid">
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select name="Business Type" required>
                    ...
                    <option value="Infrastructure / EPC Contractor">Infrastructure / EPC Contractor</option>
                    <option value="Services / B2B Trading">Services / B2B Trading</option>
              ...
              <div class="form-grid">
                <div class="form-group">
                  ...
                  <select name="Funding Requirement" required>
                    <option value="">Select primary need</option>
                    <option value="Business Loan / OD Limit">Business Loan / OD Limit</option>
                    <option value="Machine Finance (SIDBI/Bank)">Machine Finance (SIDBI/Bank)</option>
                    <option value="Real Estate / Construction Finance">Real Estate / Construction Finance</option>
                    <option value="Invoice Discounting / Trade Finance">Invoice Discounting / Trade Finance</option>
                    <option value="Refinancing / NPA Settlement (OTS)">Refinancing / NPA Settlement (OTS)</option>
                    <option value="Business Valuation Certification">Business Valuation Certification</option>
                    <option value="SME IPO / Mainboard Listing">SME IPO / Mainboard Listing</option>
                    <option value="UP Government Incentive Scheme">UP Government Incentive Scheme</option>
                  </select>
                </div>
                <div class="form-group">
                  <label>Required Funding Amount *</label>
                  <select name="Required Funding Amount" required>
              ...
              <div class="form-group full-width">
                ...
                <textarea name="Message / Detail of Project" rows="4" placeholder="Briefly describe what you are building or the nature of your cash flow requirement..."></textarea>
              </div>
