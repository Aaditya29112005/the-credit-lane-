<?php
/**
 * Template for hospital-funding.php
 */
?>
        ...
        <section class="service-banner">
          <div class="wrap">
            <div>
              <div class="breadcrumbs"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a> / <a href="<?php echo esc_url(home_url('/')); ?>">Loans</a> / Hospital Funding</div>
              <span class="eyebrow" style="color:var(--gold-light);">LOANS</span>
              <h1>Hospital Funding</h1>
              <p class="lead">Funding for hospital construction, medical equipment and working capital — sized against patient revenue and insurance receivables.</p>
            ...
            <div class="service-banner-art">
              <div class="service-banner-art-img" style="background-image: url('https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?q=80&w=1200&auto=format&fit=crop');"></div>
            </div>
          </div>
          
          <div class="stat-strip">
            <div class="wrap">
              <div class="stat-strip-item"><div class="v">Up to ₹15Cr</div><div class="k">Loan size</div></div><div class="stat-strip-item"><div class="v">8.75% – 16% p.a.</div><div class="k">Interest rate*</div></div><div class="stat-strip-item"><div class="v">Up to 7 yrs</div><div class="k">Equipment tenure</div></div>
            </div>
          </div>
        </section>
        ...
        <section style="background-color: var(--white); border-bottom:1px solid var(--line);">
          <div class="wrap">
            <div class="service-content-grid">
              ...
              <div class="service-main-col">
                ...
                <div class="service-section" id="overview">
                  ...
                  <p>Hospital funding sits at the intersection of infrastructure and equipment finance, since most facilities need both civil construction and high-value medical equipment financed together or in close sequence.</p><p>Established multi-specialty hospitals with adequate collateral can access bank pricing around 8.25–9.5% per annum; NBFCs charge more (9–16%+) but process in 3–7 days versus 10–20 days for banks and often accept equipment hypothecation instead of additional property collateral.</p><p>Because a meaningful share of hospital revenue is delayed through insurance and TPA settlement cycles, working capital facilities for healthcare providers are typically sized with that lag built in, rather than assuming immediate cash realisation.</p>
                  <p style="font-size:12px; color:var(--muted); font-style:italic; margin-top:20px;">*Banks ~8.25–9.5% for established hospitals with collateral; NBFCs 9–16%+ with faster turnaround.</p>
                </div>
                ...
                <div class="service-section" id="eligibility">
                  ...
                  <p>Fits registered clinical establishments financing equipment, bed capacity or both — not personal medical loans.</p>
                  
                  <div class="who-summary-box">
                    <div><b>Best for:</b> hospitals/diagnostic centres adding equipment or bed capacity.</div><div><b>Think twice if:</b> you need funds faster than 3 days — bank-priced facilities take longer to sanction.</div>
                  </div>

                  <ul class="qualify-bullets">
                    <li>Setting up a new facility or adding bed capacity</li><li>Purchasing high-value diagnostic or surgical equipment</li><li>Managing receivables delays from insurance/TPA settlements</li><li>Established practice looking to formalise into a larger facility</li>
                  </ul>
                </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Equipment-specific financing</h3>
                <p>Dedicated lines for diagnostic, ICU and surgical equipment with vendor-direct payment.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Receivables-aware structuring</h3>
                <p>Working capital sized with insurance/TPA settlement delays factored in.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Expansion + infra combined</h3>
                <p>Single relationship spans new construction and equipment procurement.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Licensing-stage support</h3>
                <p>Documentation guidance for facilities still completing regulatory approvals.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                ...
                <p>Current capacity, licensing status and expansion plan reviewed.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Sizing</h3>
                <p>Loan structured against equipment cost, construction estimate or both.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Sanction</h3>
                <p>Terms finalised with vendor-direct payment for equipment tranches.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Disbursal</h3>
                <p>Funds released to vendors/contractors per procurement or construction stage.</p>
              </div>
            </div>
                ...
                <div class="service-section" id="calculator">
                  ...
                  <h2 style="margin-top:8px; margin-bottom:12px;">Hospital Medical Equipment & Building Expansion Finance Estimator</h2>
        ...
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Medical Equipment & Facility Outlay</span>
            <span class="value-output" id="emi-p-val">₹50,00,000</span>
          </div>
          <input type="range" class="calc-slider" id="emi-p" min="1000000" max="150000000" step="1500000" value="7500000" oninput="updateEmiCalc()" onchange="updateEmiCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: #E2DDD5; cursor: pointer; accent-color: #C89B3C;">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Healthcare Loan Rate (% p.a.)</span>
            <span class="value-output" id="emi-r-val">11%</span>
          </div>
          <input type="range" class="calc-slider" id="emi-r" min="8.75" max="16" step="0.1" value="11" oninput="updateEmiCalc()" onchange="updateEmiCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: #E2DDD5; cursor: pointer; accent-color: #C89B3C;">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Healthcare Loan Tenure</span>
            <span class="value-output" id="emi-y-val">7 yrs</span>
          </div>
          <input type="range" class="calc-slider" id="emi-y" min="1" max="7" step="1" value="7" oninput="updateEmiCalc()" onchange="updateEmiCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: #E2DDD5; cursor: pointer; accent-color: #C89B3C;">
        </div>
        ...
        <div>
          <div class="calc-output-head" style="font-size: 11.5px; font-weight: 700; color: #C89B3C; letter-spacing: 0.1em; text-transform: uppercase; margin-bottom: 8px;">ESTIMATED HEALTHCARE EMI</div>
        ...
        <a href="#apply" class="calc-apply-btn" style="display: block; width: 100%; text-align: center; background: linear-gradient(135deg, #C89B3C 0%, #B8860B 100%); color: #0B1F3A; font-weight: 700; font-size: 15px; padding: 14px 20px; border-radius: 10px; text-decoration: none; margin-top: 16px; box-shadow: 0 6px 20px rgba(184,134,11,0.3);">Apply for In-Principle Sanction &rarr;</a>
            ...
            <div class="faq-item open">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Can equipment and construction be financed under one facility? <span>−</span></button>
              <div class="faq-a">
                <p>Yes, they're commonly combined, with separate tranches and vendor-direct payment for equipment.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Does TPA receivable delay affect loan eligibility? <span>+</span></button>
              <div class="faq-a">
                <p>It's factored into working capital sizing rather than treated as a red flag — this is standard for the sector.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Is this available for diagnostic centres, not just full hospitals? <span>+</span></button>
              <div class="faq-a">
                <p>Yes, diagnostic and specialty centres qualify under the same equipment and infrastructure lines.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Bank or NBFC — which should I choose? <span>+</span></button>
              <div class="faq-a">
                <p>Banks are cheaper (8.25–9.5%) if you have collateral and can wait 2–3 weeks; NBFCs (9–16%) fund in days and accept equipment as security — we help you weigh the trade-off.</p>
              </div>
            </div>
