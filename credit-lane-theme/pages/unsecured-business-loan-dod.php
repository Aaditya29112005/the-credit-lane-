<?php
/**
 * Template for unsecured-business-loan-dod.php
 */
?>
        ...
        <section class="service-banner">
          <div class="wrap">
            <div>
              <div class="breadcrumbs"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a> / <a href="<?php echo esc_url(home_url('/')); ?>">Loans</a> / Unsecured Business Loan & DOD Limit</div>
              <span class="eyebrow" style="color:var(--gold-light);">LOANS</span>
              <h1>Unsecured Business Loan & DOD Limit</h1>
              <p class="lead">Unsecured term loans and drop-line overdraft limits sized to your GST turnover — in-principle approval in as little as 24 hours.</p>
            ...
            <div class="service-banner-art">
              <div class="service-banner-art-img" style="background-image: url('https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?q=80&w=1200&auto=format&fit=crop');"></div>
            </div>
          </div>
          
          <div class="stat-strip">
            <div class="wrap">
              <div class="stat-strip-item"><div class="v">₹5L – ₹5Cr</div><div class="k">Loan amount</div></div><div class="stat-strip-item"><div class="v">14% – 26% p.a.</div><div class="k">Interest rate*</div></div><div class="stat-strip-item"><div class="v">12 – 60 mo</div><div class="k">Tenure</div></div>
            </div>
          </div>
        </section>
          ...
          <div class="wrap">
            <div class="service-content-grid">
              ...
              <div class="service-main-col">
                ...
                <div class="service-section" id="overview">
                  ...
                  <p>An unsecured business loan gives your company working capital without pledging property, machinery or inventory — sanctioned on the strength of your GST turnover, banking conduct and credit history rather than a fixed asset.</p><p>Because no collateral backs the exposure, pricing runs higher than secured credit: unsecured NBFC loans in the current market typically fall between 14% and 26% per annum, though government-backed CGTMSE schemes can bring select borrowers down to 10.5–13%.</p><p>A drop-line overdraft (DOD) limit works alongside or instead of a term loan — you draw only what you need against a sanctioned ceiling, and interest accrues solely on the drawn balance, which keeps carrying cost low for seasonal cash gaps.</p>
                  <p style="font-size:12px; color:var(--muted); font-style:italic; margin-top:20px;">*Unsecured NBFC pricing. CGTMSE-backed schemes can bring eligible borrowers down to 10.5–13% p.a.</p>
                </div>
                ...
                <div class="service-section" id="eligibility">
                  ...
                  <p>This product fits businesses that value speed and flexibility over chasing the lowest possible rate.</p>
                  
                  <div class="who-summary-box">
                    <div><b>Best for:</b> established firms needing fast, asset-free working capital.</div><div><b>Think twice if:</b> you can pledge property or machinery for a materially lower secured rate.</div>
                  </div>

                  <ul class="qualify-bullets">
                    <li>Business vintage of 2+ years with stable GST filings</li><li>Need working capital for inventory, payroll or short-term cash gaps</li><li>Want to avoid mortgaging property or machinery</li><li>Existing bank relationship but no fresh collateral to offer</li>
                  </ul>
                </div>
            ...
            <div class="feature-block">
              ...
              <div>
                ...
                <p>Sanctioned purely against turnover, banking and credit profile.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Drop-line overdraft option</h3>
                <p>Interest charged only on the amount drawn, not the full limit.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Multi-lender comparison</h3>
                <p>Your file is run across 15+ banks and NBFCs for the sharpest rate.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>CGTMSE eligibility check</h3>
                <p>We check government-backed guarantee schemes that can cut your rate.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                ...
                <p>Share GST, bank and ITR data — digitised the same day.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                ...
                <p>Your file is matched against live rate cards from our panel.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Sanction & terms</h3>
                <p>Compare 2–3 sanction letters side by side before you choose.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Disbursal</h3>
                <p>Funds credited directly to your current account.</p>
              </div>
            </div>
                ...
                <div class="service-section" id="calculator">
                  ...
                  <h2 style="margin-top:8px; margin-bottom:12px;">Unsecured Working Capital & Drop-Line OD Estimator</h2>
        ...
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Turnover / Working Capital Credit Limit</span>
            <span class="value-output" id="emi-p-val">₹50,00,000</span>
          </div>
          <input type="range" class="calc-slider" id="emi-p" min="200000" max="50000000" step="500000" value="2000000" oninput="updateEmiCalc()" onchange="updateEmiCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: linear-gradient(to right, #C89B3C 0%, #C89B3C 50%, #363636 50%, #363636 100%); cursor: pointer; accent-color: #C89B3C;">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Unsecured Interest Rate (p.a. indicative)</span>
            <span class="value-output" id="emi-r-val">18%</span>
          </div>
          <input type="range" class="calc-slider" id="emi-r" min="10.5" max="26" step="0.1" value="18" oninput="updateEmiCalc()" onchange="updateEmiCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: linear-gradient(to right, #C89B3C 0%, #C89B3C 50%, #363636 50%, #363636 100%); cursor: pointer; accent-color: #C89B3C;">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Repayment / OD Limit Tenure</span>
            <span class="value-output" id="emi-y-val">3 yrs</span>
          </div>
          <input type="range" class="calc-slider" id="emi-y" min="1" max="5" step="1" value="3" oninput="updateEmiCalc()" onchange="updateEmiCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: linear-gradient(to right, #C89B3C 0%, #C89B3C 50%, #363636 50%, #363636 100%); cursor: pointer; accent-color: #C89B3C;">
        </div>
        ...
        <div>
          <div class="calc-output-head" style="font-size: 11.5px; font-weight: 700; color: #C89B3C; letter-spacing: 0.1em; text-transform: uppercase; margin-bottom: 8px;">ESTIMATED MONTHLY EMI / OD INTEREST</div>
        ...
        <a href="#apply" class="calc-apply-btn" style="display: block; width: 100%; text-align: center; background: linear-gradient(135deg, #C89B3C 0%, #B8860B 100%); color: #0B1F3A; font-weight: 700; font-size: 15px; padding: 14px 20px; border-radius: 10px; text-decoration: none; margin-top: 16px; box-shadow: 0 6px 20px rgba(184,134,11,0.3);">Apply for In-Principle Sanction &rarr;</a>
            ...
            <div class="faq-item open">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Is any collateral needed at all? <span>−</span></button>
              <div class="faq-a">
                <p>No. Sanction is based on turnover, banking conduct and credit score — not fixed assets.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">How is a DOD limit different from a term loan? <span>+</span></button>
              <div class="faq-a">
                <p>A term loan disburses the full amount upfront with fixed EMIs. A DOD limit is a revolving line — you draw and repay within the limit and pay interest only on the utilised amount.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">What CIBIL score is typically required? <span>+</span></button>
              <div class="faq-a">
                <p>700+ is preferred by most lenders, though a strong banking profile can offset a slightly lower score.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Can I get a lower rate through a government scheme? <span>+</span></button>
              <div class="faq-a">
                <p>CGTMSE-backed schemes can bring eligible MSME borrowers down to roughly 10.5–13% p.a. — we check this alongside your standard application.</p>
              </div>
            </div>
