<?php
/**
 * Template for invoice-finance.php
 */
?>
        ...
        <section class="service-banner">
          <div class="wrap">
            <div>
              <div class="breadcrumbs"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a> / <a href="<?php echo esc_url(home_url('/')); ?>">Loans</a> / Sale Invoice Finance / Purchase Invoice Finance</div>
              <span class="eyebrow" style="color:var(--gold-light);">LOANS</span>
              <h1>Sale Invoice Finance / Purchase Invoice Finance</h1>
              <p class="lead">Convert receivables into immediate working capital, or finance purchases against upcoming payables — without waiting out your buyer's credit cycle.</p>
            ...
            <div class="service-banner-art">
              <div class="service-banner-art-img" style="background-image: url('https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?q=80&w=1200&auto=format&fit=crop');"></div>
            </div>
          </div>
          
          <div class="stat-strip">
            <div class="wrap">
              <div class="stat-strip-item"><div class="v">75% – 90%</div><div class="k">Of invoice value advanced</div></div><div class="stat-strip-item"><div class="v">From 12% p.a.</div><div class="k">Discounting cost*</div></div><div class="stat-strip-item"><div class="v">24 – 72 hrs</div><div class="k">Funds against invoice</div></div>
            </div>
          </div>
        </section>
        ...
        <section style="background-color: var(--white); border-bottom:1px solid var(--line);">
          <div class="wrap">
            <div class="service-content-grid">
              ...
              <div class="service-main-col">
                ...
                <div class="service-section" id="overview">
                  ...
                  <p>Sale invoice finance advances cash against confirmed receivables, letting a business collect early instead of waiting out a buyer's payment cycle — particularly useful when selling to large corporates with long standard credit terms.</p><p>Advances typically run 75–90% of invoice value, with the discounting cost priced at roughly 1.5–3% per month depending on your buyer's credit strength — cheaper than most unsecured working capital because the receivable itself is the security.</p><p>Purchase invoice finance works in reverse, funding payment to your suppliers against a confirmed purchase order, which helps maintain supplier relationships and unlock early-payment discounts.</p>
                  <p style="font-size:12px; color:var(--muted); font-style:italic; margin-top:20px;">*Discounting typically priced 1.5–3% per month of invoice value depending on buyer credit strength and tenor.</p>
                </div>
                ...
                <div class="service-section" id="eligibility">
                  ...
                  <p>Fits businesses selling on credit terms to reputable buyers, where the payment gap — not creditworthiness — is the constraint.</p>
                  
                  <div class="who-summary-box">
                    <div><b>Best for:</b> B2B sellers with 30–90 day buyer credit terms and strong receivables.</div><div><b>Think twice if:</b> your buyers are small/unrated — pricing depends heavily on buyer credit quality.</div>
                  </div>

                  <ul class="qualify-bullets">
                    <li>Selling to large corporates or PSUs on 30–90 day credit terms</li><li>Cash flow is stretched between delivery and payment realisation</li><li>Need to pay suppliers before your own receivables come in</li><li>Want financing tied to transactions, not a fixed term loan</li>
                  </ul>
                </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Receivables unlocked fast</h3>
                <p>Advance released within 24–72 hours of invoice acceptance.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Buyer-credit based pricing</h3>
                <p>Rate often reflects your buyer's credit strength, not just yours.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Purchase-side cover</h3>
                <p>Finance supplier payments against confirmed purchase orders.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Revolving structure</h3>
                <p>Repeat draws as new invoices are raised, without fresh sanction each time.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Invoice/PO review</h3>
                <p>We assess buyer credit quality and invoice authenticity.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Facility sanction</h3>
                <p>A revolving limit is set based on projected monthly invoice volume.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Draw-down</h3>
                <p>Submit invoices as raised; funds advanced within days.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Settlement</h3>
                <p>Facility is repaid as the buyer/you settle the underlying invoice.</p>
              </div>
            </div>
                ...
                <div class="service-section" id="calculator">
                  ...
                  <h2 style="margin-top:8px; margin-bottom:12px;">Supply Chain Invoice & Receivable Discounting Estimator</h2>
        ...
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Outstanding Approved Invoice Value</span>
            <span class="value-output" id="inv-val-val">₹10,00,000</span>
          </div>
          <input type="range" class="calc-slider" id="inv-val" min="100000" max="10000000" step="50000" value="1000000" oninput="updateInvoiceCalc()" onchange="updateInvoiceCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: linear-gradient(to right, #C89B3C 0%, #C89B3C 50%, #363636 50%, #363636 100%); cursor: pointer; accent-color: #C89B3C;">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Upfront Advance Percentage</span>
            <span class="value-output" id="inv-adv-val">85%</span>
          </div>
          <input type="range" class="calc-slider" id="inv-adv" min="60" max="90" step="1" value="85" oninput="updateInvoiceCalc()" onchange="updateInvoiceCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: linear-gradient(to right, #C89B3C 0%, #C89B3C 50%, #363636 50%, #363636 100%); cursor: pointer; accent-color: #C89B3C;">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Credit Due Period (Days)</span>
            <span class="value-output" id="inv-days-val">60 days</span>
          </div>
          <input type="range" class="calc-slider" id="inv-days" min="15" max="120" step="5" value="60" oninput="updateInvoiceCalc()" onchange="updateInvoiceCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: linear-gradient(to right, #C89B3C 0%, #C89B3C 50%, #363636 50%, #363636 100%); cursor: pointer; accent-color: #C89B3C;">
        </div>
        ...
        <a href="#apply" class="calc-apply-btn" style="display: block; width: 100%; text-align: center; background: #C89B3C; color: #0B1F3A; font-weight: 700; font-size: 15px; padding: 14px 20px; border-radius: 10px; text-decoration: none; margin-top: 16px;">Apply for In-Principle Sanction &rarr;</a>
            ...
            <div class="faq-item open">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Does my buyer need to be involved in the process? <span>−</span></button>
              <div class="faq-a">
                <p>Some structures require buyer acknowledgement of the invoice; others don't — we confirm which applies to your buyer base.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Is this the same as a cash credit limit? <span>+</span></button>
              <div class="faq-a">
                <p>No — it's transaction-linked and tied to specific invoices/POs, rather than a general-purpose revolving limit against stock and receivables.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">What if a buyer delays payment beyond the invoice term? <span>+</span></button>
              <div class="faq-a">
                <p>Terms vary by facility — we structure this upfront so you know exactly how delays are handled before drawing down.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">How is the discounting cost calculated? <span>+</span></button>
              <div class="faq-a">
                <p>Typically 1.5–3% per month on the advanced amount, prorated for the actual number of days outstanding — you're not charged for the full tenor if the buyer pays early.</p>
              </div>
            </div>
