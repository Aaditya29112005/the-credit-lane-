      ...
      <div class="wrap">
        <div class="about-hero-grid">
          ...
          <div style="position: relative; width: 100%;">
            <div style="background: rgba(255, 255, 255, 0.04); border: 1.5px solid rgba(200, 155, 60, 0.4); border-radius: 20px; padding: 12px; box-shadow: 0 20px 50px rgba(0,0,0,0.5); backdrop-filter: blur(10px); cursor: pointer;" onclick="openGalleryModal('<?php echo $gallery_base; ?>image copy 8.png')">
              <img src="<?php echo $gallery_base; ?>image copy 8.png" alt="The Credit Lane Executive Team &amp; Office" style="width: 100%; height: 420px; object-fit: cover; border-radius: 14px; display: block; box-shadow: 0 8px 25px rgba(0,0,0,0.3);">
            </div>
          </div>
        </div>
      </div>
