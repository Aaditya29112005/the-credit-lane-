      ...
      <div class="wrap">
        <div class="about-hero-grid" style="display: grid; grid-template-columns: 1.05fr 0.95fr; gap: 40px; align-items: center;">
          ...
          <div style="position: relative; width: 100%; display: flex; justify-content: center; align-items: center;">
            <div style="width: 100%; background: rgba(255, 255, 255, 0.04); border: 1.5px solid rgba(200, 155, 60, 0.4); border-radius: 20px; padding: 10px; box-shadow: 0 20px 50px rgba(0,0,0,0.5); backdrop-filter: blur(10px); cursor: pointer;" onclick="openGalleryModal('<?php echo $gallery_base; ?>image copy 8.png')">
              <img src="<?php echo $gallery_base; ?>image copy 8.png" alt="The Credit Lane Executive Exhibition &amp; Office Stall" style="width: 100%; height: 100%; max-height: 460px; object-fit: cover; border-radius: 14px; display: block; box-shadow: 0 8px 25px rgba(0,0,0,0.3);">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="wrap">
        <div style="text-align: center; max-width: 850px; margin: 0 auto 48px;">
          ...
          <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
            <a href="<?php echo esc_url(get_template_directory_uri() . '/assets/docs/The-Credit-Lane-Company-Profile.pdf?v=1.2.5'); ?>" download="The-Credit-Lane-Company-Profile.pdf" target="_blank" class="btn btn-primary" style="padding: 16px 36px; font-size: 16px; font-weight: 700; box-shadow: 0 10px 30px rgba(184,134,11,0.3);">📥 Download Company Profile PDF (Direct File)</a>
