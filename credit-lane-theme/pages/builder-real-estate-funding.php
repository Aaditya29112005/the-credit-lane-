<?php
/**
 * Template for builder-real-estate-funding.php
 */
?>
        ...
        <section class="service-banner">
          <div class="wrap">
            <div>
              <div class="breadcrumbs"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a> / <a href="<?php echo esc_url(home_url('/')); ?>">Loans</a> / Builder and Real Estate Developers Funding</div>
              <span class="eyebrow" style="color:var(--gold-light);">LOANS</span>
              <h1>Builder and Real Estate Developers Funding</h1>
              <p class="lead">Project-linked funding for developers — from land acquisition and approvals through construction-linked disbursal.</p>
            ...
            <div class="service-banner-art">
              <div class="service-banner-art-img" style="background-image: url('https://images.unsplash.com/photo-1541888946425-d81bb19240f5?q=80&w=1200&auto=format&fit=crop');"></div>
            </div>
          </div>
          
          <div class="stat-strip">
            <div class="wrap">
              <div class="stat-strip-item"><div class="v">Up to 70%</div><div class="k">Of project cost financed*</div></div><div class="stat-strip-item"><div class="v">11% – 16% p.a.</div><div class="k">Interest rate</div></div><div class="stat-strip-item"><div class="v">Up to 5 yrs</div><div class="k">Project tenure</div></div>
            </div>
          </div>
        </section>
        ...
        <section style="background-color: var(--white); border-bottom:1px solid var(--line);">
          <div class="wrap">
            <div class="service-content-grid">
              ...
              <div class="service-main-col">
                ...
                <div class="service-section" id="overview">
                  ...
                  <p>Developer funding is structured fundamentally differently from a standard business loan — disbursal is tied to construction milestones rather than released upfront, which controls interest cost and aligns with RERA-mandated escrow practices.</p><p>Financing typically covers up to 70% of construction cost (excluding land), priced at roughly 11–16% per annum depending on project risk, developer track record and location, with tenure generally capped at 5 years for a single project cycle.</p><p>Because project risk is assessed on title clarity, approval status and developer track record together, early-stage due diligence is often the difference between a smooth sanction and a stalled one — this is where we front-load the work.</p>
                  <p style="font-size:12px; color:var(--muted); font-style:italic; margin-top:20px;">*Excludes land cost; disbursal released against construction milestones, not upfront.</p>
                </div>
                ...
                <div class="service-section" id="eligibility">
                  ...
                  <p>For developers with an approved plan ready to break ground, not early-stage land speculation.</p>
                  
                  <div class="who-summary-box">
                    <div><b>Best for:</b> developers with clear title and an approved plan, seeking milestone-linked funds.</div><div><b>Think twice if:</b> your project lacks RERA registration — most lenders require it before sanction.</div>
                  </div>

                  <ul class="qualify-bullets">
                    <li>Developer with an approved layout/building plan ready to break ground</li><li>Need funding across land, approvals or construction — not just one stage</li><li>Project has clear title and RERA registration in progress or complete</li><li>Looking for disbursal tied to construction milestones, not lump sum</li>
                  </ul>
                </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Milestone-linked disbursal</h3>
                <p>Funds released in stages as construction progresses, reducing idle interest cost.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>RERA-aligned structuring</h3>
                <p>Facility documentation built to align with RERA escrow requirements.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Land + construction coverage</h3>
                <p>Single relationship can span acquisition, approval costs and construction.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Exit-linked repayment</h3>
                <p>Repayment structured against projected unit sales/collections.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Project due diligence</h3>
                <p>Title, approvals and developer track record verified.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                ...
                <p>Loan sized and staged against the construction timeline.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Sanction</h3>
                <p>Terms finalised including escrow and milestone conditions.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Milestone disbursal</h3>
                <p>Tranches released as each construction stage is certified complete.</p>
              </div>
            </div>
        ...
        <div class="calc-bar" id="c_bar">
          ...
          <div class="calc-bar-i" id="bar-i"></div>
            ...
            <div class="faq-item open">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Can this fund land acquisition before construction begins? <span>−</span></button>
              <div class="faq-a">
                <p>Yes, though land-only funding typically carries a shorter tenure and stricter title requirements than construction-linked tranches.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">How does RERA escrow affect disbursal? <span>+</span></button>
              <div class="faq-a">
                <p>A portion of buyer collections must stay in a RERA-designated account for construction — we structure loan disbursal to work alongside this, not around it.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">What if the project timeline slips? <span>+</span></button>
              <div class="faq-a">
                <p>Milestone-linked facilities typically allow renegotiation of tranche timing — we flag this during structuring so it isn't a surprise mid-project.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Why is the rate higher than a property purchase loan? <span>+</span></button>
              <div class="faq-a">
                <p>Construction finance carries higher execution risk than a purchase against a completed asset, which is reflected in the 11–16% pricing band versus 8.5–14% for purchase loans.</p>
              </div>
            </div>
