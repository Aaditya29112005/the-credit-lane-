<?php
/**
 * Template for up-tus-scheme.php
 */
?>
        ...
        <section class="service-banner">
          <div class="wrap">
            <div>
              <div class="breadcrumbs"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a> / <a href="<?php echo esc_url(home_url('/')); ?>">Incentives</a> / UP Govt Technical Upgradation Support (TUS) Scheme</div>
              <span class="eyebrow" style="color:var(--gold-light);">INCENTIVES</span>
              <h1>UP Govt Technical Upgradation Support (TUS) Scheme</h1>
              <p class="lead">Up to ₹15 lakh in state subsidy for machinery, equipment and quality-certification costs — with a further 15% for green and women-led units.</p>
            ...
            <div class="service-banner-art">
              <div class="service-banner-art-img" style="background-image: url('https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=1200&auto=format&fit=crop');"></div>
            </div>
          </div>
          
          <div class="stat-strip">
            <div class="wrap">
              <div class="stat-strip-item"><div class="v">₹7.5L micro / ₹15L small</div><div class="k">Maximum subsidy</div></div><div class="stat-strip-item"><div class="v">+15%</div><div class="k">Green / women bonus</div></div><div class="stat-strip-item"><div class="v">3+ years</div><div class="k">Minimum unit age</div></div>
            </div>
          </div>
        </section>
        ...
        <section style="background-color: var(--white); border-bottom:1px solid var(--line);">
          <div class="wrap">
            <div class="service-content-grid">
              ...
              <div class="service-main-col">
                ...
                <div class="service-section" id="overview">
                  ...
                  <p>The Technical Upgradation Support (TUS) Scheme gives operational micro and small units in Uttar Pradesh direct financial support to buy machinery and equipment or fund quality-improvement interventions — including BIS, FSSAI and management-system certification costs.</p><p>Subsidy is capped at ₹7.5 lakh for micro units and ₹15 lakh for small units when applying for multiple items under the scheme, with an additional 15% subsidy layered on for units adopting green solutions — solar, renewable energy, retrofitted devices — or owned by women entrepreneurs.</p><p>Applications are processed first-come-first-served through the DIEPC, reviewed by a district-level technical committee and approved by a state-level committee — which makes application timing genuinely material to whether funds are still available.</p>
                  <p style="font-size:12px; color:var(--muted); font-style:italic; margin-top:20px;">Per Uttar Pradesh's Technical Upgradation Support Scheme, administered via the District Industries and Enterprise Promotion Centre (DIEPC).</p>
                </div>
                ...
                <div class="service-section" id="eligibility">
                  ...
                  <p>For operational micro/small units in UP upgrading machinery or pursuing quality certification, not new units still setting up.</p>
                  
                  <div class="who-summary-box">
                    <div><b>Best for:</b> micro/small units, 3+ years old, investing in machinery or certification (BIS/FSSAI/ISO).</div><div><b>Not eligible if:</b> you've already received a grant under the UP Industrial Investment Policy 2017 or another state/central scheme for the same purpose.</div>
                  </div>

                  <ul class="qualify-bullets">
                    <li>Micro or small unit that has been operational for at least 3 years</li><li>Planning to purchase machinery/equipment or pursue quality certification</li><li>Have not already received a grant under UP's 2017 industrial policy or a similar scheme</li><li>Willing to apply promptly — allocation is first-come-first-served</li>
                  </ul>
                </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Machinery & equipment subsidy</h3>
                <p>Direct support toward the cost of new machinery and equipment purchases.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Certification cost coverage</h3>
                <p>BIS, FSSAI, ISO and management-system certification costs included.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Green & women-owned bonus</h3>
                <p>An additional 15% subsidy for solar/renewable adoption or women-led units.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Two-tier committee review</h3>
                <p>District technical committee plus state-level approval for transparency.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                ...
                <p>Unit age, prior grants and planned expenditure verified against scheme rules.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                ...
                <p>Online application submitted to the District Industries and Enterprise Promotion Centre.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>District technical review</h3>
                <p>District-level technical committee examines the application.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>State approval & disbursal</h3>
                <p>State committee approves and the subsidy is disbursed to the unit.</p>
              </div>
            </div>
                ...
                <div class="service-section" id="calculator">
                  ...
                  <h2 style="margin-top:8px; margin-bottom:12px;">UP TUS 50% Capital Subsidy Claim Estimator</h2>
        ...
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Total Machinery Purchase Invoice Cost</span>
            <span class="value-output" id="sub-cost-val">₹20,00,000</span>
          </div>
          <input type="range" class="calc-slider" id="sub-cost" min="100000" max="50000000" step="100000" value="2000000" oninput="updateSubsidyCalc()" onchange="updateSubsidyCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: linear-gradient(to right, #C89B3C 0%, #C89B3C 50%, #363636 50%, #363636 100%); cursor: pointer; accent-color: #C89B3C;">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Policy Subsidy Claim Rate</span>
            <span class="value-output" id="sub-rate-val">20%</span>
          </div>
          <input type="range" class="calc-slider" id="sub-rate" min="5" max="30" step="1" value="20" oninput="updateSubsidyCalc()" onchange="updateSubsidyCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: linear-gradient(to right, #C89B3C 0%, #C89B3C 50%, #363636 50%, #363636 100%); cursor: pointer; accent-color: #C89B3C;">
        </div>
        ...
        <a href="#apply" class="calc-apply-btn" style="display: block; width: 100%; text-align: center; background: #C89B3C; color: #0B1F3A; font-weight: 700; font-size: 15px; padding: 14px 20px; border-radius: 10px; text-decoration: none; margin-top: 16px;">Apply for In-Principle Sanction &rarr;</a>
            ...
            <div class="faq-item open">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Is this scheme only for buying machinery? <span>−</span></button>
              <div class="faq-a">
                <p>No — it also covers quality-improvement interventions like BIS, FSSAI and management-system certification, not just equipment purchase.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">What does 'first come first serve' actually mean in practice? <span>+</span></button>
              <div class="faq-a">
                <p>Applications are processed in the order received once the window opens; once the district/state allocation is exhausted, later applications may not be funded in that cycle — timing your application matters.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Can a unit that already received a UP 2017 policy grant apply for TUS? <span>+</span></button>
              <div class="faq-a">
                <p>No, units that have already received benefits under the UP Industrial Investment and Employment Promotion Policy 2017 or a similar scheme are not eligible.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">How is the green/women-owned bonus applied? <span>+</span></button>
              <div class="faq-a">
                <p>It's an additional 15% subsidy layered on top of the standard TUS support, for units adopting green/renewable solutions or owned by women entrepreneurs.</p>
              </div>
            </div>
