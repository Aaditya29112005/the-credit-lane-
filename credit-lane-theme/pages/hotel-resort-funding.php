<?php
/**
 * Template for hotel-resort-funding.php
 */
?>
        ...
        <section class="service-banner">
          <div class="wrap">
            <div>
              <div class="breadcrumbs"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a> / <a href="<?php echo esc_url(home_url('/')); ?>">Loans</a> / Hotel & Resort Funding</div>
              <span class="eyebrow" style="color:var(--gold-light);">LOANS</span>
              <h1>Hotel & Resort Funding</h1>
              <p class="lead">Construction, renovation and working capital finance for hotels and resorts — structured around occupancy seasonality, not flat monthly EMIs.</p>
            ...
            <div class="service-banner-art">
              <div class="service-banner-art-img" style="background-image: url('https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=1200&auto=format&fit=crop');"></div>
            </div>
          </div>
          
          <div class="stat-strip">
            <div class="wrap">
              <div class="stat-strip-item"><div class="v">Up to 70%</div><div class="k">Of project cost financed*</div></div><div class="stat-strip-item"><div class="v">9% – 14% p.a.</div><div class="k">Interest rate</div></div><div class="stat-strip-item"><div class="v">Up to 12 yrs</div><div class="k">Tenure</div></div>
            </div>
          </div>
        </section>
        ...
        <section style="background-color: var(--white); border-bottom:1px solid var(--line);">
          <div class="wrap">
            <div class="service-content-grid">
              ...
              <div class="service-main-col">
                ...
                <div class="service-section" id="overview">
                  ...
                  <p>Hospitality projects carry a cash flow pattern that standard term loans handle poorly — occupancy and revenue swing seasonally, so repayment structuring needs to flex accordingly rather than assume flat monthly income.</p><p>Pricing generally runs 9–14% per annum — banks around 9–11% for well-collateralised projects, NBFCs up to 14% with materially faster approval — with construction finance covering up to 70% of project cost excluding land.</p><p>Beyond room construction, hotels and resorts often need financing for banquet halls, F&B outlets and amenity infrastructure that drive non-room revenue — this is typically bundled into the same facility rather than financed separately.</p>
                  <p style="font-size:12px; color:var(--muted); font-style:italic; margin-top:20px;">*Excludes land cost. Banks typically price ~9–11%; NBFCs up to ~14% with faster turnaround.</p>
                </div>
                ...
                <div class="service-section" id="eligibility">
                  ...
                  <p>Fits hospitality operators whose revenue genuinely swings by season, not businesses wanting a generic construction loan.</p>
                  
                  <div class="who-summary-box">
                    <div><b>Best for:</b> hotels/resorts needing EMIs that flex with occupancy season.</div><div><b>Think twice if:</b> your property has flat year-round demand — a standard term loan may be simpler.</div>
                  </div>

                  <ul class="qualify-bullets">
                    <li>Building a new property or renovating an existing hotel/resort</li><li>Revenue is seasonal and a flat EMI schedule doesn't fit cash flow</li><li>Need working capital to bridge low-occupancy months</li><li>Expanding room inventory or adding banquet/F&B infrastructure</li>
                  </ul>
                </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Seasonality-matched EMIs</h3>
                <p>Higher repayment in peak season, lower in off-season — not a flat schedule.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Renovation + new-build coverage</h3>
                <p>Applies equally to greenfield construction and existing property upgrades.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>F&B and banquet financing</h3>
                <p>Covers ancillary revenue infrastructure, not just room inventory.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Brand-tie-up consideration</h3>
                <p>Loan terms can reflect projected revenue uplift from franchise/management tie-ups.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Property & market review</h3>
                <p>Location, competing supply and occupancy potential assessed.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Project sizing</h3>
                <p>Loan structured against construction/renovation cost and revenue projection.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Sanction</h3>
                <p>Seasonal repayment schedule finalised against projected occupancy curve.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Phased disbursal</h3>
                <p>Funds released against construction milestones or renovation stages.</p>
              </div>
            </div>
                ...
                <div class="service-section" id="calculator">
                  ...
                  <h2 style="margin-top:8px; margin-bottom:12px;">Hospitality & Resort Infrastructure Finance Calculator</h2>
        ...
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Hotel Property Purchase / Renovation Cost</span>
            <span class="value-output" id="emi-p-val">₹50,00,000</span>
          </div>
          <input type="range" class="calc-slider" id="emi-p" min="2500000" max="300000000" step="3000000" value="30000000" oninput="updateEmiCalc()" onchange="updateEmiCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: #E2DDD5; cursor: pointer; accent-color: #C89B3C;">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Hospitality Loan Rate (% p.a.)</span>
            <span class="value-output" id="emi-r-val">11%</span>
          </div>
          <input type="range" class="calc-slider" id="emi-r" min="9" max="14" step="0.1" value="11" oninput="updateEmiCalc()" onchange="updateEmiCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: #E2DDD5; cursor: pointer; accent-color: #C89B3C;">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Hospitality Repayment Tenure</span>
            <span class="value-output" id="emi-y-val">10 yrs</span>
          </div>
          <input type="range" class="calc-slider" id="emi-y" min="2" max="12" step="1" value="10" oninput="updateEmiCalc()" onchange="updateEmiCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: #E2DDD5; cursor: pointer; accent-color: #C89B3C;">
        </div>
        ...
        <div>
          <div class="calc-output-head" style="font-size: 11.5px; font-weight: 700; color: #C89B3C; letter-spacing: 0.1em; text-transform: uppercase; margin-bottom: 8px;">ESTIMATED HOSPITALITY EMI</div>
        ...
        <a href="#apply" class="calc-apply-btn" style="display: block; width: 100%; text-align: center; background: linear-gradient(135deg, #C89B3C 0%, #B8860B 100%); color: #0B1F3A; font-weight: 700; font-size: 15px; padding: 14px 20px; border-radius: 10px; text-decoration: none; margin-top: 16px; box-shadow: 0 6px 20px rgba(184,134,11,0.3);">Apply for In-Principle Sanction &rarr;</a>
            ...
            <div class="faq-item open">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Can this fund renovation of an existing property, not just new builds? <span>−</span></button>
              <div class="faq-a">
                <p>Yes — renovation financing follows the same seasonality-matched structuring as new construction.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">How is the seasonal EMI schedule decided? <span>+</span></button>
              <div class="faq-a">
                <p>Based on historical or projected occupancy data for the specific location and property category.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Does a management/franchise tie-up improve loan terms? <span>+</span></button>
              <div class="faq-a">
                <p>It can — projected revenue uplift from an established brand affiliation is factored into sizing and pricing where relevant.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Why is NBFC pricing higher than bank pricing here? <span>+</span></button>
              <div class="faq-a">
                <p>NBFCs price in the speed and flexibility they offer — often closing in under two weeks against 4–12 weeks for a bank, which matters for seasonal construction windows.</p>
              </div>
            </div>
