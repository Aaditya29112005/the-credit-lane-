...
?>
        ...
        <div class="calc-input-group">
          ...
          <input type="range" class="calc-slider" id="emi-p" min="2500000" max="300000000" step="3000000" value="30000000" oninput="updateEmiCalc()" onchange="updateEmiCalc()">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
          ...
          <input type="range" class="calc-slider" id="emi-r" min="9" max="14" step="0.1" value="11" oninput="updateEmiCalc()" onchange="updateEmiCalc()">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
          ...
          <input type="range" class="calc-slider" id="emi-y" min="2" max="12" step="1" value="10" oninput="updateEmiCalc()" onchange="updateEmiCalc()">
        </div>
