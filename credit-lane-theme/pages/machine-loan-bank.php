<?php
/**
 * Template for machine-loan-bank.php
 */
?>
        ...
        <section class="service-banner">
          <div class="wrap">
            <div>
              <div class="breadcrumbs"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a> / <a href="<?php echo esc_url(home_url('/')); ?>">Loans</a> / Machine Loan from Bank</div>
              <span class="eyebrow" style="color:var(--gold-light);">LOANS</span>
              <h1>Machine Loan from Bank</h1>
              <p class="lead">When you'd rather finance new machinery through your existing bank, we structure the file and negotiate terms on your behalf.</p>
            ...
            <div class="service-banner-art">
              <div class="service-banner-art-img" style="background-image: url('https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?q=80&w=1200&auto=format&fit=crop');"></div>
            </div>
          </div>
          
          <div class="stat-strip">
            <div class="wrap">
              <div class="stat-strip-item"><div class="v">9% – 13% p.a.</div><div class="k">Interest rate</div></div><div class="stat-strip-item"><div class="v">Up to 80%</div><div class="k">Machine cost financed</div></div><div class="stat-strip-item"><div class="v">3 – 7 yrs</div><div class="k">Tenure</div></div>
            </div>
          </div>
        </section>
        ...
        <section style="background-color: var(--white); border-bottom:1px solid var(--line);">
          <div class="wrap">
            <div class="service-content-grid">
              ...
              <div class="service-main-col">
                ...
                <div class="service-section" id="overview">
                  ...
                  <p>A standard bank machine loan is often the fastest route when a business already holds a banking relationship, since much of the KYC and credit assessment reuses existing records.</p><p>Pricing typically runs 9–13% per annum, secured against the machinery itself, with up to 80% of invoice value financed and tenure stretching 3–7 years depending on the asset's useful life.</p><p>Where this route differs from SIDBI or scheme-linked finance is flexibility — banks can structure tenure, moratorium and repayment around your specific cash flow rather than a fixed scheme template.</p>
                  <p style="font-size:12px; color:var(--muted); font-style:italic; margin-top:20px;">Typical secured machinery loan pricing from scheduled banks; final rate depends on relationship and credit profile.</p>
                </div>
                ...
                <div class="service-section" id="eligibility">
                  ...
                  <p>Fits businesses that want to keep financing within an existing bank relationship rather than route through a scheme.</p>
                  
                  <div class="who-summary-box">
                    <div><b>Best for:</b> businesses with an existing bank relationship wanting a faster, familiar process.</div><div><b>Think twice if:</b> you qualify for SIDBI's SPEED scheme — that route is usually cheaper.</div>
                  </div>

                  <ul class="qualify-bullets">
                    <li>Have an existing current account or credit relationship with a bank</li><li>Prefer a single-bank relationship over multi-lender scheme routes</li><li>Buying machinery where SIDBI scheme criteria don't apply</li><li>Need faster turnaround using an existing banking file</li>
                  </ul>
                </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Relationship-based pricing</h3>
                <p>Leverages your existing banking history to negotiate rate and tenure.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Broad machine coverage</h3>
                <p>Applicable across manufacturing, printing, textile, food-processing and more.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Moratorium structuring</h3>
                <p>Repayment holiday negotiated for machines with a commissioning lag.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Multi-bank rate check</h3>
                <p>We benchmark your primary bank's offer against 3–4 alternatives before you sign.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                ...
                <p>We pull comparative quotes from your bank and 3 alternatives.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                ...
                <p>Financials and machine specs compiled into the lender's format.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Sanction</h3>
                <p>Bank issues terms; we negotiate rate, tenure and moratorium if needed.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Disbursal</h3>
                <p>Payment released to vendor on invoice, machine delivery confirmed.</p>
              </div>
            </div>
                ...
                <div class="service-section" id="calculator">
                  ...
                  <h2 style="margin-top:8px; margin-bottom:12px;">Bank Equipment & Machinery Purchase Loan Calculator</h2>
        ...
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Total Machinery Invoice Value</span>
            <span class="value-output" id="emi-p-val">₹50,00,000</span>
          </div>
          <input type="range" class="calc-slider" id="emi-p" min="500000" max="20000000" step="200000" value="4000000" oninput="updateEmiCalc()" onchange="updateEmiCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: #E2DDD5; cursor: pointer; accent-color: #C89B3C;">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Bank Loan Interest Rate (% p.a.)</span>
            <span class="value-output" id="emi-r-val">11%</span>
          </div>
          <input type="range" class="calc-slider" id="emi-r" min="9" max="13" step="0.1" value="11" oninput="updateEmiCalc()" onchange="updateEmiCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: #E2DDD5; cursor: pointer; accent-color: #C89B3C;">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
          ...
          <input type="range" class="calc-slider" id="emi-y" min="3" max="7" step="1" value="5" oninput="updateEmiCalc()" onchange="updateEmiCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: #E2DDD5; cursor: pointer; accent-color: #C89B3C;">
        </div>
        ...
        <div>
          <div class="calc-output-head" style="font-size: 11.5px; font-weight: 700; color: #C89B3C; letter-spacing: 0.1em; text-transform: uppercase; margin-bottom: 8px;">ESTIMATED BANK MACHINERY EMI</div>
        ...
        <a href="#apply" class="calc-apply-btn" style="display: block; width: 100%; text-align: center; background: linear-gradient(135deg, #C89B3C 0%, #B8860B 100%); color: #0B1F3A; font-weight: 700; font-size: 15px; padding: 14px 20px; border-radius: 10px; text-decoration: none; margin-top: 16px; box-shadow: 0 6px 20px rgba(184,134,11,0.3);">Apply for In-Principle Sanction &rarr;</a>
            ...
            <div class="faq-item open">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Does staying with my existing bank guarantee the best rate? <span>−</span></button>
              <div class="faq-a">
                <p>Not automatically — we still benchmark against other lenders, and use competing offers to negotiate your bank's terms.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Can I get a moratorium before EMIs start? <span>+</span></button>
              <div class="faq-a">
                <p>Yes, particularly if the machine needs installation or commissioning time before it generates revenue.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">What if my bank rejects the file? <span>+</span></button>
              <div class="faq-a">
                <p>We re-route the same file to an alternate bank or NBFC in our panel without restarting documentation from scratch.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">How does this compare with SIDBI's rates? <span>+</span></button>
              <div class="faq-a">
                <p>SIDBI's SPEED/SPEED Plus schemes (8.8–10.5%) typically undercut standard bank machine loans (9–13%) for eligible MSMEs — we check SIDBI eligibility first.</p>
              </div>
            </div>
