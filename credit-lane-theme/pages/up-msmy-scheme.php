...
?>
        ...
        <div class="calc-input-group">
          ...
          <input type="range" class="calc-slider" id="sub-cost" min="100000" max="50000000" step="100000" value="500000" oninput="updateSubsidyCalc()" onchange="updateSubsidyCalc()">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
          ...
          <input type="range" class="calc-slider" id="sub-rate" min="5" max="30" step="1" value="10" oninput="updateSubsidyCalc()" onchange="updateSubsidyCalc()">
        </div>
