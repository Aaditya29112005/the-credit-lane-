...
?>
        ...
        <section class="service-banner">
          <div class="wrap">
            <div>
              <div class="breadcrumbs"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a> / <a href="<?php echo esc_url(home_url('/')); ?>">Equity</a> / SME IPO</div>
              <span class="eyebrow" style="color:var(--gold-light);">EQUITY</span>
              <h1>SME IPO</h1>
              <p class="lead">A lighter-compliance route to public markets for companies with post-issue paid-up capital up to ₹25 crore and a 3-year track record.</p>
            ...
            <div class="service-banner-art">
              <div class="service-banner-art-img" style="background-image: url('https://images.unsplash.com/photo-1535320903710-d993d3d77d29?q=80&w=1200&auto=format&fit=crop');"></div>
            </div>
          </div>
          
          <div class="stat-strip">
            <div class="wrap">
              <div class="stat-strip-item"><div class="v">≤ ₹25Cr</div><div class="k">Post-issue capital cap</div></div><div class="stat-strip-item"><div class="v">3+ years</div><div class="k">Track record required</div></div><div class="stat-strip-item"><div class="v">4 – 6 months</div><div class="k">Listing timeline</div></div>
            </div>
          </div>
        </section>
        ...
        <section style="background-color: var(--white); border-bottom:1px solid var(--line);">
          <div class="wrap">
            <div class="service-content-grid">
              ...
              <div class="service-main-col">
                ...
                <div class="service-section" id="overview">
                  ...
                  <p>BSE SME and NSE Emerge are purpose-built platforms letting smaller companies access public markets without meeting the stricter, costlier mainboard rules — post-issue paid-up capital must not exceed ₹25 crore, with net worth of at least ₹1 crore in each of the preceding two years.</p><p>Profitability isn't mandatory, but the company must show operating profit (EBITDA) in at least 2 of the last 3 financial years, backed by 3 years of audited financials that feed directly into the Draft Red Herring Prospectus (DRHP).</p><p>The listing process — DRHP filing, exchange review, a site inspection of company facilities, and appearance before the Listing Advisory Committee — typically runs 4–6 months from mandate to listing, with a minimum 20% promoter contribution held in demat form.</p>
                  <p style="font-size:12px; color:var(--muted); font-style:italic; margin-top:20px;">Per BSE SME / NSE Emerge norms: net worth >=₹1Cr in each of the last 2 years, EBITDA-positive in 2 of the last 3 years, min. 20% promoter contribution.</p>
                </div>
                ...
                <div class="service-section" id="eligibility">
                  ...
                  <p>For established SMEs ready for public market discipline without mainboard-scale requirements.</p>
                  
                  <div class="who-summary-box">
                    <div><b>Best for:</b> companies with 3+ years' track record and post-issue capital under ₹25Cr.</div><div><b>Think twice if:</b> you have pending IBC proceedings or promoter defaults — these disqualify SME listing.</div>
                  </div>

                  <ul class="qualify-bullets">
                    <li>Company or promoter with at least 3 years of operating track record</li><li>Post-issue paid-up capital fits within the ₹25 crore SME threshold</li><li>EBITDA-positive in at least 2 of the last 3 financial years</li><li>No pending defaults or IBC proceedings against the company</li>
                  </ul>
                </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Platform eligibility mapping</h3>
                <p>Assessment of BSE SME vs NSE Emerge fit based on your financials and structure.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>DRHP drafting support</h3>
                <p>Coordination with merchant banker on prospectus drafting and SEBI-format compliance.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Exchange process coordination</h3>
                <p>Support through site inspection and Listing Advisory Committee presentation.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Market maker & underwriting coordination</h3>
                <p>Arrangement of mandatory market making and underwriting for the issue.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Eligibility & platform assessment</h3>
                <p>Financials and structure reviewed against BSE SME / NSE Emerge criteria.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>DRHP drafting & filing</h3>
                <p>Merchant banker drafts the DRHP; filed with the chosen exchange.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                ...
                <p>Site inspection and promoter interaction before the Listing Advisory Committee.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Price band & subscription</h3>
                <p>In-principle approval received; issue opens for subscription.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Listing</h3>
                <p>Shares allotted and the company lists on BSE SME or NSE Emerge.</p>
              </div>
            </div>
                ...
                <div class="service-section" id="calculator">
                  ...
                  <h2 style="margin-top:8px; margin-bottom:12px;">SME Public Listing (IPO) Fresh Issue Valuation Estimator</h2>
        ...
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Fresh Issue Capital Sizing</span>
            <span class="value-output" id="ipo-issue-val">₹8,00,00,000</span>
          </div>
          <input type="range" class="calc-slider" id="ipo-issue" min="10000000" max="1000000000" step="5000000" value="80000000" oninput="updateIpoCalc()" onchange="updateIpoCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: linear-gradient(to right, #C89B3C 0%, #C89B3C 50%, #363636 50%, #363636 100%); cursor: pointer; accent-color: #C89B3C;">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
          ...
          <input type="range" class="calc-slider" id="ipo-pre" min="50000000" max="4000000000" step="10000000" value="250000000" oninput="updateIpoCalc()" onchange="updateIpoCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: linear-gradient(to right, #C89B3C 0%, #C89B3C 50%, #363636 50%, #363636 100%); cursor: pointer; accent-color: #C89B3C;">
        </div>
        ...
        <a href="#apply" class="calc-apply-btn" style="display: block; width: 100%; text-align: center; background: #C89B3C; color: #0B1F3A; font-weight: 700; font-size: 15px; padding: 14px 20px; border-radius: 10px; text-decoration: none; margin-top: 16px;">Apply for In-Principle Sanction &rarr;</a>
            ...
            <div class="faq-item open">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">What's the difference between BSE SME and NSE Emerge? <span>−</span></button>
              <div class="faq-a">
                <p>Both are SME-focused platforms with similar eligibility norms; the choice often comes down to sector fit, market maker arrangements and merchant banker relationships — we assess both before recommending one.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Does my company need to be profitable to list? <span>+</span></button>
              <div class="faq-a">
                <p>No, profitability isn't mandatory, but EBITDA-positive results in at least 2 of the last 3 financial years are required.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">What is the Listing Advisory Committee? <span>+</span></button>
              <div class="faq-a">
                <p>An exchange committee that reviews the DRHP, conducts a site inspection and interacts with promoters before granting in-principle listing approval.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Can an SME-listed company migrate to the mainboard later? <span>+</span></button>
              <div class="faq-a">
                <p>Yes, companies that outgrow SME thresholds and meet mainboard eligibility criteria can migrate to NSE/BSE mainboard listing.</p>
              </div>
            </div>
