...
?>
        ...
        <div class="calc-input-group">
          ...
          <input type="range" class="calc-slider" id="sub-cost" min="100000" max="50000000" step="100000" value="20000000" oninput="updateSubsidyCalc()" onchange="updateSubsidyCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: #E2DDD5; cursor: pointer; accent-color: #C89B3C;">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
          ...
          <input type="range" class="calc-slider" id="sub-rate" min="5" max="30" step="1" value="15" oninput="updateSubsidyCalc()" onchange="updateSubsidyCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: #E2DDD5; cursor: pointer; accent-color: #C89B3C;">
        </div>
