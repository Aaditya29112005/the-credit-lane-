<?php
/**
 * Template for up-msme-scheme.php
 */
?>
        ...
        <section class="service-banner">
          <div class="wrap">
            <div>
              <div class="breadcrumbs"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a> / <a href="<?php echo esc_url(home_url('/')); ?>">Incentives</a> / UP Govt MSME Promotion Policy Scheme</div>
              <span class="eyebrow" style="color:var(--gold-light);">INCENTIVES</span>
              <h1>UP Govt MSME Promotion Policy Scheme</h1>
              <p class="lead">Up to 25% capital subsidy, up to 100% stamp duty exemption and 5-year interest subvention for new MSME units under UP's 2022 policy.</p>
            ...
            <div class="service-banner-art">
              <div class="service-banner-art-img" style="background-image: url('https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?q=80&w=1200&auto=format&fit=crop');"></div>
            </div>
          </div>
          
          <div class="stat-strip">
            <div class="wrap">
              <div class="stat-strip-item"><div class="v">10% – 25%</div><div class="k">Capital subsidy (region-based)</div></div><div class="stat-strip-item"><div class="v">Up to 100%</div><div class="k">Stamp duty exemption*</div></div><div class="stat-strip-item"><div class="v">50% – 60%</div><div class="k">Interest subvention, 5 years</div></div>
            </div>
          </div>
        </section>
        ...
        <section style="background-color: var(--white); border-bottom:1px solid var(--line);">
          <div class="wrap">
            <div class="service-content-grid">
              ...
              <div class="service-main-col">
                ...
                <div class="service-section" id="overview">
                  ...
                  <p>Under the UP Micro, Small and Medium Enterprises Promotion Policy 2022, new MSME units get a capital subsidy of 10–25% depending on region — Bundelkhand and Purvanchal sit at the higher 15–25% band, while central and western UP (including the NCR-adjacent districts) are set at 10–20%, capped at ₹4 crore per unit, with a further 2% for SC/ST and women entrepreneurs.</p><p>Stamp duty exemption follows the same regional logic: 100% in Purvanchal and Bundelkhand, 75% in Madhyanchal and Paschimanchal, but only 50% in Gautam Buddh Nagar and Ghaziabad specifically — women entrepreneurs get 100% exemption anywhere in the state regardless of region.</p><p>New micro units also qualify for interest subvention of 50% on their loan's annual interest (60% for SC/ST and women entrepreneurs) for 5 years, capped at ₹25 lakh per unit, alongside a 7-year infrastructure interest subsidy for eligible projects.</p>
                  <p style="font-size:12px; color:var(--muted); font-style:italic; margin-top:20px;">*100% in Purvanchal/Bundelkhand, 75% in Madhyanchal/Paschimanchal, 50% in Gautam Buddh Nagar & Ghaziabad — 100% for women entrepreneurs statewide. Per UP MSME Promotion Policy 2022.</p>
                </div>
                ...
                <div class="service-section" id="eligibility">
                  ...
                  <p>For new MSME units being set up in UP — the benefit size depends materially on which region you're setting up in.</p>
                  
                  <div class="who-summary-box">
                    <div><b>Best for:</b> new units in Purvanchal/Bundelkhand (highest subsidy tier) or any women-led unit statewide.</div><div><b>Note:</b> Ghaziabad and Gautam Buddh Nagar units get a reduced 50% stamp duty exemption versus 100% elsewhere.</div>
                  </div>

                  <ul class="qualify-bullets">
                    <li>Setting up a new micro, small or medium enterprise in Uttar Pradesh</li><li>Want capital subsidy, stamp duty relief or interest subvention — or a combination</li><li>Fall under SC/ST or women-entrepreneur categories for enhanced benefits</li><li>Need infrastructure interest subsidy support for a new project</li>
                  </ul>
                </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Region-tiered capital subsidy</h3>
                <p>10–25% subsidy on project cost, capped at ₹4Cr, based on district.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Stamp duty exemption</h3>
                <p>Up to 100% exemption on land/property registration, region-dependent.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>5-year interest subvention</h3>
                <p>50–60% discount on annual loan interest, capped at ₹25L per unit.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>7-year infra interest subsidy</h3>
                <p>Extended interest relief for eligible infrastructure investment.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Policy fit assessment</h3>
                <p>Region, category (general/SC-ST/women) and project cost mapped to applicable benefit tiers.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Application via single window</h3>
                <p>Application filed through Invest UP / Nivesh Mitra single-window portal.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                ...
                <p>Project and eligibility documents verified by the district authority.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Sanction & disbursal</h3>
                <p>Capital subsidy, stamp duty relief and/or interest subvention sanctioned and released.</p>
              </div>
            </div>
                ...
                <div class="service-section" id="calculator">
                  ...
                  <h2 style="margin-top:8px; margin-bottom:12px;">UP MSME Promotion Policy Capital Grant Calculator</h2>
        ...
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Total Industrial Plant / Project Outlay</span>
            <span class="value-output" id="sub-cost-val">₹20,00,000</span>
          </div>
          <input type="range" class="calc-slider" id="sub-cost" min="100000" max="50000000" step="100000" value="20000000" oninput="updateSubsidyCalc()" onchange="updateSubsidyCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: linear-gradient(to right, #C89B3C 0%, #C89B3C 50%, #363636 50%, #363636 100%); cursor: pointer; accent-color: #C89B3C;">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
            <span>Subsidy Percentage Category</span>
            <span class="value-output" id="sub-rate-val">15%</span>
          </div>
          <input type="range" class="calc-slider" id="sub-rate" min="5" max="30" step="1" value="15" oninput="updateSubsidyCalc()" onchange="updateSubsidyCalc()" style="width: 100%; height: 8px; border-radius: 4px; outline: none; -webkit-appearance: none; appearance: none; background: linear-gradient(to right, #C89B3C 0%, #C89B3C 50%, #363636 50%, #363636 100%); cursor: pointer; accent-color: #C89B3C;">
        </div>
        <input type="hidden" id="sub-cap" value="4000000">
        ...
        <a href="#apply" class="calc-apply-btn" style="display: block; width: 100%; text-align: center; background: #C89B3C; color: #0B1F3A; font-weight: 700; font-size: 15px; padding: 14px 20px; border-radius: 10px; text-decoration: none; margin-top: 16px;">Apply for In-Principle Sanction &rarr;</a>
            ...
            <div class="faq-item open">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Why does my subsidy depend on which district I'm in? <span>−</span></button>
              <div class="faq-a">
                <p>The policy deliberately tiers benefits higher in less-industrialised regions (Purvanchal, Bundelkhand) to encourage investment there, versus already-developed NCR-adjacent districts like Ghaziabad and Gautam Buddh Nagar.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Can I combine capital subsidy, stamp duty exemption and interest subvention? <span>+</span></button>
              <div class="faq-a">
                <p>Yes, these are separate benefit heads under the same policy and can typically be availed together, subject to each head's own eligibility and caps.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Is the 100% stamp duty exemption for women available everywhere, including Ghaziabad? <span>+</span></button>
              <div class="faq-a">
                <p>Yes — the policy grants 100% stamp duty exemption to women entrepreneurs statewide, overriding the lower regional tier that would otherwise apply.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">How long does the interest subvention last? <span>+</span></button>
              <div class="faq-a">
                <p>5 years for the standard capital interest subvention on new micro units (up to ₹25 lakh per unit), and 7 years for the separate infrastructure interest subsidy where applicable.</p>
              </div>
            </div>
