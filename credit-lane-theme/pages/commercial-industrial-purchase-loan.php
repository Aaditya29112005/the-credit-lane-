<?php
/**
 * Template for commercial-industrial-purchase-loan.php
 */
?>
        ...
        <section class="service-banner">
          <div class="wrap">
            <div>
              <div class="breadcrumbs"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a> / <a href="<?php echo esc_url(home_url('/')); ?>">Loans</a> / Commercial or Industrial Purchase Loan</div>
              <span class="eyebrow" style="color:var(--gold-light);">LOANS</span>
              <h1>Commercial or Industrial Purchase Loan</h1>
              <p class="lead">Structured finance to purchase commercial shops, offices or industrial plots — repaid over a tenure that matches your business cycle.</p>
            ...
            <div class="service-banner-art">
              <div class="service-banner-art-img" style="background-image: url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=1200&auto=format&fit=crop');"></div>
            </div>
          </div>
          
          <div class="stat-strip">
            <div class="wrap">
              <div class="stat-strip-item"><div class="v">50% – 75%</div><div class="k">Loan-to-value</div></div><div class="stat-strip-item"><div class="v">8.5% – 14% p.a.</div><div class="k">Interest rate*</div></div><div class="stat-strip-item"><div class="v">Up to 15 yrs</div><div class="k">Tenure</div></div>
            </div>
          </div>
        </section>
          ...
          <div class="wrap">
            <div class="service-content-grid">
              ...
              <div class="service-main-col">
                ...
                <div class="service-section" id="overview">
                  ...
                  <p>A commercial or industrial purchase loan lets a business acquire operating premises without depleting working capital, with the property itself serving as security.</p><p>Loan-to-value generally runs 50–75% of the registered property value, with banks pricing at the lower end (around 8.5–11% p.a.) and NBFCs typically 10–14% depending on borrower profile, property type and loan size.</p><p>Because tenure can stretch to 15 years, EMIs are often lower than the rent a business would otherwise pay — converting a recurring cost into a growing asset.</p>
                  <p style="font-size:12px; color:var(--muted); font-style:italic; margin-top:20px;">*Public/private banks typically price 8.5–11%; NBFCs and HFCs 10–14%, depending on profile and property type.</p>
                </div>
                ...
                <div class="service-section" id="eligibility">
                  ...
                  <p>Best suited to businesses ready to trade a long-term EMI for ownership of the space they operate from.</p>
                  
                  <div class="who-summary-box">
                    <div><b>Best for:</b> businesses currently renting premises, ready to own instead.</div><div><b>Think twice if:</b> you need the property's full value unlocked quickly — LTV caps at 75%.</div>
                  </div>

                  <ul class="qualify-bullets">
                    <li>Currently paying rent for business premises and want to own instead</li><li>Buying an industrial plot or shed to relocate or expand operations</li><li>Need a loan structured against both business and property cash flows</li><li>Looking to free up working capital instead of paying cash for property</li>
                  </ul>
                </div>
            ...
            <div class="feature-block">
              ...
              <div>
                ...
                <p>Finance up to 75% of the registered property value.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Balance transfer support</h3>
                <p>Move an existing commercial property loan to a lower rate.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Flexible end-use</h3>
                <p>Applies to shops, showrooms, offices, warehouses and industrial plots.</p>
              </div>
            </div>
            ...
            <div class="feature-block">
              ...
              <div>
                <h3>Co-applicant structuring</h3>
                <p>Combine promoter and firm income to maximise eligibility.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                ...
                <p>Legal team checks title, encumbrance and zoning before you commit.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Valuation</h3>
                <p>Empanelled valuers assess fair market value for loan sizing.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Sanction</h3>
                <p>Lender issues terms based on property value and business income.</p>
              </div>
            </div>
            ...
            <div class="route-timeline-step">
              ...
              <div>
                <h3>Registration & disbursal</h3>
                <p>Funds released in sync with registration and legal formalities.</p>
              </div>
            </div>
        ...
        <div class="calc-input-group">
          ...
          <input type="range" class="calc-slider" id="emi-p" min="2000000" max="100000000" step="1000000" value="10000000" oninput="updateEmiCalc()" onchange="updateEmiCalc()">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
          ...
          <input type="range" class="calc-slider" id="emi-r" min="8.5" max="14" step="0.1" value="11" oninput="updateEmiCalc()" onchange="updateEmiCalc()">
        </div>
        <div class="calc-input-group">
          <div class="calc-input-label">
        ...
        <div class="calc-bar" id="c_bar">
          ...
          <div class="calc-bar-i" id="bar-i"></div>
            ...
            <div class="faq-item open">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Can I include renovation cost in the loan? <span>−</span></button>
              <div class="faq-a">
                <p>Yes, most lenders allow a top-up for fit-out or renovation once the base purchase loan is sanctioned.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Is a co-applicant mandatory? <span>+</span></button>
              <div class="faq-a">
                <p>Not mandatory, but adding a co-applicant (partner/promoter) often improves eligibility and rate.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">What happens if the property has unclear title? <span>+</span></button>
              <div class="faq-a">
                <p>We flag title issues during legal vetting before applying — resolving these upfront avoids sanction delays later.</p>
              </div>
            </div>

            <div class="faq-item ">
              <button type="button" class="faq-q" onclick="toggleFaq(this)">Bank or NBFC — which is cheaper? <span>+</span></button>
              <div class="faq-a">
                <p>Banks are typically cheaper (8.5–11%) but slower and stricter on documentation; NBFCs move faster at 10–14%. We benchmark both before you decide.</p>
              </div>
            </div>
